/*!
 * \file file_module.h
 * \brief File transfer and synchronization capability module.
 * \ingroup cosmos_modules
 * \defgroup cosmos_file_module File Module
 *
 * Encapsulates the file-transfer capability as a composable module that can be
 * attached to any agent. Integrates transferclass with the agent's packet
 * handler and scheduler to provide autonomous, reliable file delivery between
 * nodes without requiring a dedicated file-agent process.
 */
