/*!
 * \file websocket_module.h
 * \brief WebSocket communication capability module.
 * \ingroup cosmos_modules
 * \defgroup cosmos_websocket_module WebSocket Module
 *
 * Provides a composable module that exposes an agent's namespace and command
 * interface over a WebSocket connection. Allows browser-based and other
 * WebSocket clients to subscribe to telemetry streams and send commands
 * without speaking the native COSMOS UDP protocol.
 */
