/*!
 * \file packethandler_module.h
 * \brief Packet routing capability module.
 * \ingroup cosmos_modules
 * \defgroup cosmos_packethandler_module Packet Handler Module
 *
 * Wraps the packethandler library as a composable module that can be added to
 * any agent. Registers packet-type callbacks, manages the dispatch table, and
 * integrates with the agent's socket infrastructure so that packet routing
